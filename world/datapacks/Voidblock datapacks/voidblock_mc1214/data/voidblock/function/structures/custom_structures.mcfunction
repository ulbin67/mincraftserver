...
execute as @a[scores={Voidblock_structures_id=30..}] run scoreboard objectives add Voidblock_custom_structures dummy
execute as @a[scores={Voidblock_structures_id=35..}] run scoreboard players add @a Voidblock_custom_structures 1
...
execute as @a[scores={Voidblock_custom_structures=5..11}] run gamemode spectator @a
...
execute as @a[scores={Voidblock_custom_structures=7..40}] run gamerule doWeatherCycle true
execute as @a[scores={Voidblock_custom_structures=10}] run time set 0
execute as @a[scores={Voidblock_custom_structures=11}] run advancement revoke @a only minecraft:nether/root
execute as @a[scores={Voidblock_custom_structures=11}] run advancement revoke @a everything
execute as @a[scores={Voidblock_custom_structures=11}] run execute in minecraft:overworld run tp @p 0 66 0 90 0
execute as @a[scores={Voidblock_custom_structures=20}] run gamemode survival @a
execute as @a[scores={Voidblock_custom_structures=20..50}] run place template voidblock:air 0 0 0
execute as @a[scores={Voidblock_custom_structures=30}] run setblock 0 0 0 minecraft:command_block[conditional=false,facing=west]{Command:'/tellraw @a [{"translate":"skyblock_classic_edition.generated_structures.generated.command_block.info","italic":true,"color":"red"},[""],{"translate":"skyblock_classic_edition.generated_structures.generated.command_block.download","italic":true,"underlined":true,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Loweredgames/Voidblock/releases"}}]',CustomName:'{"text":"@"}',SuccessCount:0,TrackOutput:1b,UpdateLastExecution:1b,auto:0b,conditionMet:0b,powered:0b} destroy
execute as @a[scores={Voidblock_custom_structures=35}] run tellraw @a ["",{"text":"If the resource pack is not in the world and can cause damage to the text: add the resource pack in the world folder or ","italic":true,"color":"gray"},{"text":"reinstall the map here","italic":true,"underlined":true,"color":"gray","clickEvent":{"action":"open_url","value":"https://github.com/Loweredgames/Voidblock/releases"}},{"text":" and add manually in the world folder.","italic":true,"color":"gray"}]
execute as @a[scores={Voidblock_custom_structures=35}] run setblock 0 1 0 minecraft:redstone_block destroy
execute as @a[scores={Voidblock_custom_structures=40}] run fill 0 0 0 0 1 0 minecraft:air destroy
execute as @a[scores={Voidblock_custom_structures=41}] run effect clear @a
execute as @a[scores={Voidblock_custom_structures=41}] run playsound minecraft:entity.player.levelup ambient @a 0 66 0 100 2
execute as @a[scores={Voidblock_custom_structures=41}] run scoreboard objectives remove Voidblock_level_dat
execute as @a[scores={Voidblock_custom_structures=45..50}] run gamerule doImmediateRespawn false


##Voidblock ID DELAY (DELAY PID DELLA CONVERSIONE, NON TOCCARE)
execute as @a[scores={Voidblock_custom_structures=100}] run scoreboard objectives add Voidblock_id dummy
...
execute as @a[scores={Voidblock_custom_structures=2000000..}] run scoreboard players set @a Voidblock_custom_structures 10000


##CONVERSIONE AL FORMATO "Voidblock_custom_structures"
