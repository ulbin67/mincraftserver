...
#execute as @a[scores={1.21.5_PVN_0e=6}] run tellraw @s ["",{"color":"red","text":"⚠WARNING: You are using a version of Minecraft that is still in development or untested, bugs may occur and the world may become corrupted and damaged. always make backups. Wait for it to be fully released.⚠"}]
