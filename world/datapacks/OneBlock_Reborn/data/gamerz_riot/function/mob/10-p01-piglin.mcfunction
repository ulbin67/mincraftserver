...
# Spawn the mobs
execute as @s at @s run summon minecraft:piglin ~ ~1.6 ~ {HandItems:[{id:"minecraft:golden_sword",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:unbreaking":1}}}},{}],"ArmorItems":[{id:"minecraft:golden_boots",count:1},{id:"minecraft:golden_leggings",count:1},{id:"minecraft:golden_chestplate",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:unbreaking":1}}}},{id:"minecraft:golden_helmet",count:1}]}
