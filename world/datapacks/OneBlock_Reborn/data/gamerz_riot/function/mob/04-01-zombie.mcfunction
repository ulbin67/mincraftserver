...
# Spawn the mobs
execute as @s at @s run summon minecraft:zombie ~ ~1.6 ~ {HandItems:[{id:"minecraft:iron_hoe",count:1},{}],ArmorItems:[{},{},{},{id:"minecraft:golden_helmet",count:1}]}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:zombie ~ ~1.6 ~ {HandItems:[{id:"minecraft:iron_hoe",count:1},{}],ArmorItems:[{},{},{},{id:"minecraft:golden_helmet",count:1}]}
