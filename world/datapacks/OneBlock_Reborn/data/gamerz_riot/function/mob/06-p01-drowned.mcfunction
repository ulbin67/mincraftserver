...
# Spawn the mobs
execute as @s at @s run summon minecraft:drowned ~ ~1.6 ~ {HandItems:[{id:"minecraft:trident",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:unbreaking":1}}}},{}],ArmorItems:[{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":1908001}},{id:"minecraft:leather_leggings",count:1},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":3949738,"minecraft:enchantments":{levels:{"minecraft:unbreaking":1}}}},{id:"minecraft:iron_helmet",count:1}]}
