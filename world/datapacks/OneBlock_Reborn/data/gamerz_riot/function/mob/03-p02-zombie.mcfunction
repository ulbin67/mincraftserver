...
# Spawn the mobs
execute as @s at @s run summon minecraft:zombie ~ ~1.6 ~ {HandItems:[{id:"minecraft:stone_sword",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:unbreaking":1}}}},{}],ArmorItems:[{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":1908001}},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:dyed_color":3949738}},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":3847130,"minecraft:enchantments":{levels:{"minecraft:unbreaking":1}}}},{id:"minecraft:iron_helmet",count:1}]}
