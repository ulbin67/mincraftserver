...
# Spawn the mobs
execute as @s at @s run summon minecraft:vindicator ~ ~1.6 ~ {HandItems:[{id:"minecraft:iron_axe",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:knockback":1}}}},{}]}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:vindicator ~ ~1.6 ~ {HandItems:[{id:"minecraft:iron_axe",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:knockback":1}}}},{}]}
